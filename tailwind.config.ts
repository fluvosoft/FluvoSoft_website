  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "ky-brand-gradient": "linear-gradient(180deg, #FF8F70 0%, #FF6B45 100%)",
      },
      fontSize: {
      ...
      fontFamily: {
        ...
        "ky-heading": ["var(--font-ky-heading)", "ui-sans-serif", "system-ui", "sans-serif"],
        "ky-body": ["var(--font-ky-body)", "ui-sans-serif", "system-ui", "sans-serif"],
