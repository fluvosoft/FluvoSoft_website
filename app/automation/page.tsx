      ...
      <main className="min-h-screen bg-background" role="main">
        <section className="px-6 py-16 lg:px-8 lg:py-24">
          <div className="mx-auto max-w-container">
            <div className="grid gap-10 lg:grid-cols-[1.25fr_0.75fr] lg:items-center lg:gap-12">
              <div>
                <h1 className="text-3xl font-bold tracking-tight text-foreground md:text-4xl lg:text-5xl">Automation Solutions</h1>
              ...
              <div className="relative mx-auto min-h-[320px] max-w-md overflow-hidden rounded-xl border border-white/10 bg-dashboard-card lg:mx-0 lg:min-h-[480px] lg:max-w-xl">
                <Image src="/images/automation.png" alt="Automation solutions" fill className="object-contain object-center" sizes="(max-width: 1024px) 100vw, 28rem" priority />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="border-t border-white/10 px-6 py-16 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-container">
            ...
            <h3 className="mt-8 text-xl font-semibold text-foreground">Data-Driven Approach</h3>
        ...
        <section className="border-t border-white/10 px-6 py-16 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-container">
            <h2 className="text-2xl font-semibold text-foreground md:text-3xl">Our Automation Process</h2>
        ...
        <section className="border-t border-white/10 px-6 py-16 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-container">
            <h2 className="text-2xl font-semibold text-foreground md:text-3xl">Automation Technologies We Use</h2>
        ...
        <section className="border-t border-white/10 px-6 py-16 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-container">
            <h2 className="text-2xl font-semibold text-foreground md:text-3xl">Our Automation Products</h2>
        ...
        <section className="border-t border-white/10 px-6 py-16 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-container text-center">
            <h2 className="text-2xl font-semibold text-foreground md:text-3xl">Ready to Automate Your Operations?</h2>
