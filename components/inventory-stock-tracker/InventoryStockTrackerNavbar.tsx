...
import { PlayStoreNavButton } from "./StoreButtons";

const navLinks = [
  { label: "Features", href: "/inventory-stock-tracker#features" },
  { label: "Pricing", href: "/inventory-stock-tracker#pricing" },
  { label: "FAQ", href: "/inventory-stock-tracker#faq" },
];
...
export default function InventoryStockTrackerNavbar() {
    ...
    <header className="sticky top-0 z-40 border-b border-ei-forest/10 bg-ei-cream/90 shadow-[0_1px_0_rgba(26,60,46,0.04)] backdrop-blur-lg">
      <div ref={navRef}>
        <nav
          ...
          aria-label="Inventory Stock Tracker navigation"
        >
        ...
        <div className="pointer-events-none absolute left-1/2 top-1/2 hidden -translate-x-1/2 -translate-y-1/2 md:block">
          <div className="pointer-events-auto flex items-center gap-1 rounded-full border border-ei-forest/10 bg-white/80 p-1.5 shadow-md backdrop-blur-sm">
            <Link
              ...
              className="max-w-[140px] truncate rounded-full px-3 py-1.5 font-ei-heading text-sm font-bold text-ei-forest no-underline"
              aria-label="Inventory Stock Tracker page top"
            >
              Stock Tracker
            </Link>
        ...
        <Link
          href="/inventory-stock-tracker"
          className="absolute left-1/2 max-w-[160px] -translate-x-1/2 truncate font-ei-heading text-sm font-bold text-ei-forest no-underline md:hidden"
        >
          Stock Tracker
        </Link>
