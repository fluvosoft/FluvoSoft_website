...
function ShowcaseBlock({ badge, title, paragraphs, left, right }: ShowcaseBlockProps) {
  return (
    <section className="border-t border-ei-primary/10 bg-white px-6 py-16 lg:px-8 lg:py-24">
      <div className="mx-auto max-w-container">
        ...
        <div className="hidden items-center gap-8 lg:grid lg:grid-cols-[1fr_1.2fr_1fr] xl:gap-12">
          ...
          <div className="flex flex-col justify-center text-center lg:text-left">
            <span className="mx-auto inline-block w-fit rounded-md bg-ei-nav/15 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-ei-primaryDark lg:mx-0">
              {badge}
            </span>
            <h2 className="mt-4 text-2xl font-bold leading-tight text-ei-textPrimary md:text-3xl lg:text-[2rem] lg:leading-[1.2]">
              {title}
            </h2>
            <div className="mt-5 space-y-4 text-base leading-relaxed text-ei-textPrimary/80">
        ...
        <div className="lg:hidden">
          <div className="text-center">
            ...
            <h2 className="mt-4 text-2xl font-bold leading-tight text-ei-textPrimary md:text-3xl">
              {title}
            </h2>
            <div className="mt-5 space-y-4 text-base leading-relaxed text-ei-textPrimary/80">
              {paragraphs.map((paragraph) => (
  ...
  return (
    <>
      <ShowcaseBlock
        ...
        title="Run your business from insight to invoice"
        paragraphs={[
      ...
      <ShowcaseBlock
        ...
        title="Professional templates and every invoice in one place"
        paragraphs={[
