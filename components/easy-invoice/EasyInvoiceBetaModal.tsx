...
export default function EasyInvoiceBetaModal({ isOpen, onClose }: EasyInvoiceBetaModalProps) {
  useEffect(() => {
    if (isOpen) {
  ...
  return (
    <div
      ...
      aria-modal="true"
      role="dialog"
      aria-labelledby="ei-beta-modal-title"
      aria-describedby="ei-beta-modal-desc"
    >
      <div
