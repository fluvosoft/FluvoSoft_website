...
export const easyInvoiceConfig: ProductSeoConfig = {
  ...
  screenshotPaths: [
    "/images/easy invoice mocup-1.webp",
    "/images/easy invoice mocup-2.webp",
    "/images/easy invoice mocup-3.webp",
    "/images/easy invoice mocup-4.webp",
  ],
